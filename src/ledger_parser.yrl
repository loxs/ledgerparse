...
Terminals '/' ':' 'int' 'float' 'interval' 'separator' 'word'.
...
transaction_head -> date interval label : {'$1', join('$3')}.
...
label -> word : [value_of('$1')].
label -> word whitespace : [value_of('$1')].
label -> word interval label : [value_of('$1'), <<" ">> | '$3'].


transaction_line -> whitespace account separator commodity_and_value : {'$2', '$4'}.
transaction_line -> whitespace account : {'$2'}.

account -> word : [value_of('$1')].
account -> word ':' account : [ value_of('$1') | '$3' ].
